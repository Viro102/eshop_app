                      ...
                      <li>
                        <a href="#">
                          <svg
                            ...
                            height="16"
                            fill="currentColor"
                            className="bi bi-star mr-1 w-4 text-blue-500 dark:text-gray-400 "
                            viewBox="0 0 16 16"
                          >
                            ...
                            <div className="flex ">
                              <span className="mr-3 text-gray-500 dark:text-gray-400">
                                <svg
                                  ...
                                  height="16"
                                  fill="currentColor"
                                  className="bi bi-diagram-3 h-7 w-7"
                                  viewBox="0 0 16 16"
                                >
                                  <path
                                    fillRule="evenodd"
                            ...
                            <div className="flex ">
                              <span className="mr-3 text-gray-500 dark:text-gray-400">
                                <svg
                                  ...
                                  height="16"
                                  fill="currentColor"
                                  className="bi bi-gpu-card h-7 w-7"
                                  viewBox="0 0 16 16"
                                >
                            ...
                            <div className="flex ">
                              <span className="mr-3 text-gray-500 dark:text-gray-400">
                                <svg
                                  ...
                                  height="16"
                                  fill="currentColor"
                                  className="bi bi-clock-history h-7 w-7"
                                  viewBox="0 0 16 16"
                                >
                  ...
                  <div className="mb-4 mr-4 lg:mb-0">
                    <div className="w-28">
                      <div className="relative flex h-10 w-full flex-row rounded-lg bg-transparent">
                        <button className="h-full w-20 cursor-pointer rounded-l border-r bg-gray-100 text-gray-600 outline-none hover:bg-gray-300 hover:text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700">
                          <span className="m-auto text-2xl font-thin">-</span>
                        </button>
                        <input
                          type="number"
                          className="text-md flex w-full items-center bg-gray-100 text-center font-semibold text-gray-700 placeholder-gray-700 outline-none hover:text-black focus:outline-none dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-400"
                          placeholder="1"
                        />
                        <button className="h-full w-20 cursor-pointer rounded-r border-l bg-gray-100 text-gray-600 outline-none hover:bg-gray-300 hover:text-gray-700 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-700">
                          <span className="m-auto text-2xl font-thin">+</span>
                        </button>
                      </div>
                    </div>
